...
/* Random Word */
    ...
    $('#rndm-word').text(getWord(['Believe', 'Faith', 'Fellowship', 'Salvation', 'Love', 'Courage', 'Honor', 'Renew', 'Celebrate', 'Discover', 'Revive', 'Encourage', 'Hope']));
